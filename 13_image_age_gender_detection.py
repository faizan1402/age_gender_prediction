...
image_to_detect = cv2.imread('images/samples/grp_photo.jpg')
...
for index,current_face_location in enumerate(all_face_locations):
    ...
    gender_protext = "Data_Set/gender_deploy.prototxt"
    gender_caffemodel = "Data_Set/gender_net.caffemodel"
    #creating the model
    ...
    #declaring the file paths
    age_protext = "Data_Set/age_deploy.prototxt"
    age_caffemodel = "Data_Set/age_net.caffemodel"
    #creating the model
